export const projects = [
  {
    ...
    img: "/assets/img/hhp.jpeg",
    link: "https://hhp-next.vercel.app/",
    purpose: "NextJs Ecommerce Store",
    tools: ["NextJs", "Woocomerce REST API", "Material UI", "Bootstrap"],
  },
  {
    id: 2,
    title: "Dominion Health Care Foundation",
    desc: "The core objective of this project is to collect donations for a non-profit organization and give awareness about the causes of the organization.",
    img: "/assets/img/dominion.jpeg",
    link: "https://dominionhealthcarefoundation.org/",
    purpose: "Collect donation for NGO",
    tools: ["ReactJs", "Netlify", "Collect.Chat", "Bootstrap"],
  },
  {
    id: 3,
    title: "Online Movie Streaming",
    desc: "The core objective of this project is to develop the mobile and web UI for a movie streaming platform. User can sign in, register themself, review their favorite movie, add the movie to their watch history, and mark done after watching that movie.",
    img: "/assets/img/movie.png",
    link: "https://online-movie-system-zeta.vercel.app/",
    purpose: "Movie Streaming Platform",
    tools: ["ReactJs", "ExpressJs", "NodeJS", "MongoDb"],
  },
  {
    id: 4,
    title: "Faster IPTV",
    desc: "The core objective of this project is to develop the mobile and web UI for a video streaming platform. This project is particularly from a UI perspective, backend stuff is not what my client asked to do.",
    img: "/assets/img/faster.png",
    link: "https://faster-iptv.netlify.app/",
    purpose: "Video Streaming Platform",
  ...
  },
  {
    ...
    link: "https://linkedin-clone-web.netlify.app/",
    purpose: "Multi-User Web Application",
  ...
  },
  {
    ...
    link: "https://next-gaming-vibes.netlify.app/",
    purpose: "Use Netlify Auth, Functions",
    tools: ["NextJs", "Netlify"],
  },
];
